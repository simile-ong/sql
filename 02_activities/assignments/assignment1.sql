...
CASE
WHEN product_name = 'pepper' THEN 1
ELSE 0
END AS 'pepper flag'
FROM product;
...
SELECT vendor_id,
COUNT (vendor_id) AS assignments_per_vendor
...
-- Total spend of each customer sorted by name
SELECT 
customer_first_name
,customer_last_name,
...
-- Imposing constraint to generate list of customers who spent more than $2000
